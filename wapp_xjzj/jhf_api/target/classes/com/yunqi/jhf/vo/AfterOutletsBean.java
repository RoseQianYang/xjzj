...
public class AfterOutletsBean {
	...
	@ApiModelProperty("网点封面")
    private String cover;
	
	@ApiModelProperty("网点图片id")
    private String imageId;
	
	@ApiModelProperty("网点图片集合")
	private List<TImage> images;
		
	@ApiModelProperty("网点联系电话")
    private String phone;
	
	@ApiModelProperty("网点图文详情")
	...
	public String toString() {
		return "AfterOutletsBean [id=" + id + ", title=" + title + ", address=" + address + ", latitude=" + latitude
