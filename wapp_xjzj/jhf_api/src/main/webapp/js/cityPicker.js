...
(function ($, win, doc) {
    ...
    p.initEvent = function () {
        this.el.on("click", function (e) {
            ...
            if (pickerBox[0]) {
                if (pickerBox.css('display') === 'none') { // 显示
                    pickerBox.show();
                } else { // 隐藏
                    pickerBox.hide();
                }
    ...
    p.proClick = function () {
        var that = this;
        $(".pro-picker dl:first-child dd").addClass("active");
        $(".pro-picker").on("click", function (e) {
            ...
            if ($(target).is("dd")) {
                ...
                $(".pro-picker").find("dd").removeClass("active");
    ...
    p.cityClick = function () {
        ...
        $(".city-picker").on("click", function (e) {
            ...
            if ($(target).is("li")) {
                ...
                $(".city-picker").find("li").removeClass("active");
                $(target).addClass("active");
                $(".picker-box").hide();
                $(".pro-picker").show();
                ...
                //$(this).hide();
                //address = that.pro + "-" + that.city;
                address = that.city;
                window.location.href = ctxPath + '/front/campsite/campsiteList.do?address=' + address;
            }
        });
    };
    ...
    p.createNavBar = function () {
        ...
        var div = '<div class="navbar-address">' + a + '</div>';
